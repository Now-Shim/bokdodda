...

{
  ...
  "dialogue": "⚠️ **고객과의 실전 대화 스크립트** (설계사 ↔ 고객, 4-5번 주고받기, 600-800자):\\n\\n**중요**: 반드시 '설계사'와 '고객'만 등장해야 합니다. '변방의 장수', '디렉터', '센터장' 등 제3자는 절대 등장하지 않습니다.\\n\\n설계사: \\"(고객의 감정 공감 - 불안/두려움 이해)\\"\\n고객: \\"(예상 반응 - 감정 표현)\\"\\n설계사: \\"(심리적 안정 제공 - 공감 심화)\\"\\n고객: \\"(예상 반응 - 신뢰 형성)\\"\\n설계사: \\"(논리적 근거 제시 - 약관/의료정보 등)\\"\\n고객: \\"(예상 반응 - 이해 단계)\\"\\n설계사: \\"(구체적 해결책 제안)\\"\\n고객: \\"(예상 반응 - 긍정적 반응)\\"",
...
2. **dialogue는 반드시 "설계사 ↔ 고객" 대화만 작성** ⚠️
   - ❌ 금지: "변방의 장수", "디렉터", "센터장", "매니저" 등 제3자 등장
   - ✅ 필수: "설계사"와 "고객"만 등장하는 실전 상담 대화
   - 형식: 6-8번 대화 주고받기 (심리학 기반 공감 포함)
3. 모든 근거는 references에 명시
4. 설계사 성향 맞춤형 조언

🎯 **근거 제시 원칙** (정확성과 책임):
1. **Director 업로드 자료 우선 참조**:
   - 제공된 [Director 업로드 자료 - 최우선 검토]를 먼저 확인
   - 해당 자료에 구체적 약관명, 조항, 법령이 있다면 정확히 인용
   - 예: "삼성화재 실손의료비보험 표준약관 제5조 2항..."

2. **외부 링크 자료 활용**:
   - 제공된 [외부 참조] URL 내용을 적극 활용
   - 크롤링된 실제 내용에서 정확한 정보 추출
   - 출처 URL을 references에 명시

3. **확인되지 않은 내용 처리**:
   - 제공된 자료에 없는 약관/법령은 추측하지 말 것
   - "정확한 확인을 위해 해당 보험사 약관 또는 전문가 상담 권장"
   - 일반적 원칙만 설명하고 구체적 조항은 언급 안함

4. **References 필수 작성**:
   - 모든 구체적 근거는 references 배열에 출처 명시
   - source, content, url을 정확히 기재`
...
**2단계: 코칭**
- coachingPoint, coachingEvidence
- **dialogue**: 고객과의 실전 대화 (설계사 ↔ 고객만 등장, 6-8번 주고받기)
- learningNeeds, actionGuidelines
