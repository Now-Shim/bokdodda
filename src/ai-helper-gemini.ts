...
2. "약관 확인하세요" ❌ → "일반적인 보험 약관에서는..." ✅
3. 설계사 성향 맞춤형 조언
4. **dialogue는 반드시 "설계사 ↔ 고객" 대화만 작성** ⚠️
...
- ❌ 존재하지 않는 약관명, 조항 번호 절대 금지
- ❌ "A생명 OOO보험 제12조", "표준약관 제5조" 같은 구체적 조항 번호 사용 금지
- ❌ 확인되지 않은 법률명, 조항 번호 절대 금지
- ✅ 대신 "일반적인 암보험 약관", "보험 계약 조건", "방사선치료 보장 내용" 같은 일반 표현 사용
- ✅ 법률/의료/약관 자문 필요 시 "전문가 상담 권장" 명시`
